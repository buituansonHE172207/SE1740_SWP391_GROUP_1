...
public class EmailService {
    ...
    public void sendActivationEmail(String to, String url, String fullName) throws MessagingException {
    ...
    public void sendResetPasswordEmail(String to, String url, String fullName) throws MessagingException {
        MimeMessage message = javaMailSender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(message, true);
