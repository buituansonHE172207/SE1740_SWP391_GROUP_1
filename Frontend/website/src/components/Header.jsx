                            ...
                            <div className="hdt-shortnews">
                                <div className="slide-left">
                                    ...
                                    <marquee behavior="scroll" direction="left">
                                        Chào mừng bạn đến với SÁCH TRỰC TUYẾN ^^ Nếu bạn cần giúp đỡ, Hãy liên lạc với chúng tôi qua số hotline: (+84) 123456789 hoặc email: sachtructuyen_cskh@gmail.com
                                    </marquee>
                                </div>
                            </div>
                        </div>
